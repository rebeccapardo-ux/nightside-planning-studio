      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 24px' }}>
        <div style={{
          ...
          <p style={{ fontFamily: hv, fontSize: '15px', lineHeight: 1.6, color: '#3a3a3a', margin: '0 0 28px 0' }}>
            One more step: designate your Legacy Contact. This is the person who can access your planning materials if you pass away.<br />It will take about 3–5 minutes.
          </p>
          <Link
