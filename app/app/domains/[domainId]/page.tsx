...
// Redirect stub for /app/domains/[domainId] → /app/area/[slug] (a safety net for old
// per-user UUID bookmarks). The segment is a per-user container UUID, so resolve it to its
// stable domain_code, map that to the area slug, and redirect. (This redirect needs a DB
// lookup, so it can't live in the edge proxy.)
